...
public partial class BloomContainer
{
    ...
    {
        private IUniformBuffer<BloomParameters> bloomParametersBuffer;
        ...
        {
            bloomParametersBuffer ??= renderer.CreateUniformBuffer<BloomParameters>();
            ...
            using (BindFrameBuffer(target))
            {
                ...
                bloomParametersBuffer.Data = bloomParametersBuffer.Data with
                {
                    Radius = kernelRadius,
                    Sigma = sigma,
                ...
                Shader.BindUniformBlock("m_BloomParameters", bloomParametersBuffer);
                Shader.Bind();
