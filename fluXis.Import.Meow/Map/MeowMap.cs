...
using fluXis.Import.Meow.Map.Structs;
...
public class MeowMap
{
    ...
    public List<MeowHitObjectInfo> HitObjects { get; set; }
    public List<MeowTimingPointInfo> TimingPoints { get; set; }
    public List<MeowSliderVelocityInfo> SliderVelocities { get; set; }
    public List<MeowBookmark> Bookmarks { get; set; }
    ...
    public MapInfo ToMapInfo()
    {
        ...
        var mapInfo = new MeowMapInfo(metadata)
        {
            Map = this,
            AudioFile = AudioFile,
